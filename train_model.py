...
route_distance = {
    ...
    ("Bangalore", "Goa"): 570, ("Chennai", "Kolkata"): 1370, ("Chennai", "Hyderabad"): 630,
    ("Hyderabad", "Kolkata"): 1490, ("Kolkata", "Goa"): 2100, ("Pune", "Goa"): 460,
}
...
for _ in range(N):
    ...
    days_before = int(np.random.choice(range(1, 91)))  # 1–90 days ahead
